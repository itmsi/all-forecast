...
Dengan mempertahankan semua partnumbers KENDARI
"""
...
def generate_exact_forecast_all_parts():
    """Generate forecast yang persis sama dengan notebook untuk semua partnumbers"""
    
    print("=== GENERATE FORECAST PERSIS SAMA DENGAN NOTEBOOK (ALL PARTS) ===\n")
    ...
    # subset sites for output - use ALL KENDARI partnumbers from original data
    ...
    # Save output
    output_file = "/app/forecast_exact_all_parts.csv"
...
if __name__ == "__main__":
    try:
        result = generate_exact_forecast_all_parts()
