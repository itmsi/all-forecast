...
Menggunakan semua data KENDARI tanpa filtering tanggal
"""
...
def generate_exact_forecast_all_data():
    """Generate forecast yang persis sama dengan notebook menggunakan semua data"""
    
    print("=== GENERATE FORECAST PERSIS SAMA DENGAN NOTEBOOK (ALL DATA) ===\n")
    ...
    # Save output
    output_file = "/app/forecast_exact_all_data.csv"
...
if __name__ == "__main__":
    try:
        result = generate_exact_forecast_all_data()
