...
Menggunakan file data asli alldemand_augjul.csv
"""
...
def main():
    # CONFIG - MENGGUNAKAN FILE DATA ASLI
    DATA_PATH = '/Users/falaqmsi/Documents/GitHub/forecast/real_data/alldemand_augjul.csv'
    FORECAST_HORIZON = 7
    FORECAST_START_DATE = None           # e.g., '2025-08-01'; None = H+1 after last history
    FORECAST_START_OFFSET_DAYS = 1

    FORECAST_SITE_CODES = ['Kendari', 'IEL-ST-KDI', 'WH-KDI-IEC']  # Site codes untuk KENDARI di file asli
    ...
    print("=== FORECAST KENDARI - MENGGUNAKAN FILE DATA ASLI ===")
    ...
    # FORECAST LOOP (fixed model + outputs)
    print("4. Generating forecasts...")
    best_est = ridge_log  # fixed

    # subset sites for output - MAP KE KENDARI
    df_sites = df[df['site_code'].isin(FORECAST_SITE_CODES)].copy()
    if df_sites.empty: raise ValueError("FORECAST_SITE_CODES tidak ditemukan di data.")

    # Map site codes to KENDARI for output
    df_sites['site_code'] = 'KENDARI'
    ...
    # Save output
    output_path = "/Users/falaqmsi/Documents/GitHub/forecast/model_for_user/forecast_kendari_original_data.csv"
