...
Menggunakan logic yang sama persis dari forecast11_ridge_only.ipynb
"""
...
def one_day_forecast(history_df, fdate, best_est, group_cols, df_sites, ZERO_THR):
...
def main():
    """Main function - copy dari notebook"""
    
    print("=== FORECAST MENGGUNAKAN LOGIC NOTEBOOK ===\n")
    
    # 0) CONFIG (keep minimal) - sama persis dengan notebook
    ...
    # 2) LOAD & NORMALIZE - sama persis dengan notebook
    print("📁 Loading data...")
    ...
    # 3) FEATURE ENGINEERING & SPLIT - sama persis dengan notebook
    ...
    # 4) MODEL = Ridge_log ONLY - sama persis dengan notebook
    ...
    for h in range(FORECAST_HORIZON):
        ...
        day_fc = one_day_forecast(hist_all, fdate, best_est, group_cols, df_sites, ZERO_THR)
    ...
    # Save output
    output_file = "/app/forecast_from_notebook.csv"
    safe_save_csv(forecast_df, output_file)
