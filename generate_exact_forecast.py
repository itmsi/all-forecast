...
Mengikuti proses dari forecast11_ridge_only.ipynb
"""
...
def generate_exact_forecast():
    """Generate forecast yang persis sama dengan notebook"""
    
    print("=== GENERATE FORECAST PERSIS SAMA DENGAN NOTEBOOK ===\n")
    ...
    # Save output
    output_file = "/app/forecast_exact_output.csv"
...
if __name__ == "__main__":
    try:
        result = generate_exact_forecast()
